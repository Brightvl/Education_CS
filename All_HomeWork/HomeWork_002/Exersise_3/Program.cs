...
if (num < 1 || num > 7) Console.WriteLine("Сколько по твоему дней в неделе?");
else if (num > 5) Console.WriteLine($"Ура, сегодня {week[num - 1]}, выходной!");
else Console.WriteLine($"Сегодня {week[num - 1]}, работай, солнце еще высоко");
